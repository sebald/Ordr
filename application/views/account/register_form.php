...
<div class="row">
  <div class="span12">
    ...
    <div class="alert-message block-message error">
      <p><strong>Sorry! The user you want to create already exists.</strong> Try the following:</p>
      <ul>
    ...
    <?php echo form_open('account/register', $attr_form); ?>
        ...
        <div class="actions">
          <?php echo form_submit('register', 'Register', 'class="btn span4 primary large"'); ?>
          <?php echo anchor('/', 'Cancel', 'class="btn large"'); ?>
        </div>
    <?php echo form_close(); ?>
  </div>
</div> 