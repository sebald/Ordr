		...
		<?php echo form_open('orders/actions', '', $hidden); ?>
			...
			<div class="page-controls">
				...
				<div class="actions">
					...
					<a href="<?php echo base_url();?>orders/new/splash/" rel="tooltip" data-original-title="New" class="btn-flat single"><i class="add"></i></a> 
...
<div id="modal-display" class="modal hide fade">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-large btn-primary">Apply Changes</button>
              <a data-dismiss="modal" class="btn btn-large" href="#">Cancel</a>
            </div>
            <?php echo form_close(); ?>
</div>